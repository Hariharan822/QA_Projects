...
1. Detects the currently active app using `dumpsys window`  
2. Captures a device screenshot  
3. Collects graphics performance using `dumpsys gfxinfo`  
4. Dumps UI hierarchy using `uiautomator`  
5. Identifies clickable elements without accessibility labels  
6. Captures memory usage details  
7. Cleans up temporary device files
